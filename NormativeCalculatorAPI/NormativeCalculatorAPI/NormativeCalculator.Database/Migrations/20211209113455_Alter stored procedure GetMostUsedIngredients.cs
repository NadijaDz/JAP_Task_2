...
{
    public partial class AlterstoredprocedureGetMostUsedIngredients : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"  
                ALTER PROCEDURE GetMostUsedIngredients @measureType int, @minQuantity float, @maxQuantity float
                AS BEGIN
  
                SELECT TOP 10 i.Name,  COUNT(ri.IngredientId) AS UsageCount
                FROM Ingredients as i 
                INNER JOIN RecipesIngredients as ri ON  i.id = ri.IngredientId  
